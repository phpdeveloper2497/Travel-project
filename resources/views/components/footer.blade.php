                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 pe-4">
                    <div class="footer-about">
                        ...
                        <ul>
                            ...
                            <li class="white"><strong>{{__('Location')}}:</strong> Collins Street, sydney, Australia</li>
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="about-us.html">{{__('Delivery Information')}}</a></li>
                            <li><a href="about-us.html">{{__('Privacy Policy')}}</a></li>
                            <li><a href="about-us.html">Terms &amp; Conditions</a></li>
                            <li><a href="about-us.html">{{__('Customer Service')}}</a></li>
                            <li><a href="#about-us.html">{{__('Return Policy')}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        <h3 class="white">{{__('Categories')}}</h3>
                        <ul>
                            <li><a href="about-us.html">{{__('Travel')}}</a></li>
                            <li><a href="about-us.html">{{__('Technology')}}</a></li>
                            <li><a href="about-us.html">{{__('Lifestyle')}}</a></li>
                            <li><a href="about-us.html">{{__('Destinations')}}</a></li>
                            <li><a href="about-us.html">{{__('Entertainment')}}</a></li>
                            <li><a href="about-us.html">{{__('Business')}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        <h3 class="white">{{__('Newsletter')}}</h3>
                        <div class="newsletter-form ">
                            ...
                            <form action="#" method="get" accept-charset="utf-8"
                                ...
                                <button class="nir-btn ms-2">{{__('Subscribe')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
